...
3) Наконец, проверяем изображение. Получаем эмбеддинг изображений в совпавших фрагментах с помощью с помощью google/vit-base-patch16-224, считаем косинусную близость.
